...
1. **Domain** — the canonical URL, Open Graph tags, JSON-LD, `sitemap.xml` and `robots.txt` all use `https://soltech.ae`. Find/replace with your real domain if different.
...
3. **Email** — `hello@soltech.ae` in the footer.
